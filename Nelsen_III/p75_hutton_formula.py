"""
Visual proof of The Formulas of Hutton.
...
class Formula(MovingCameraScene):
    def construct(self):
        ...
        txt_title = [
            ...
            Tex(r"Hutton", font_size=48, color=BLACK),
        ]
        ...
        # Formula
        txt_formula = Tex(r"$\frac{\pi}{4} = 2\arctan \frac{1}{3} + \arctan \frac{1}{7}$", font_size=28, color=BLACK)\
            .move_to([0, 3, 0])
