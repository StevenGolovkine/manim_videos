"""
Visual proof of Centered Triangular Numbers 1.
...
class Tri(MovingCameraScene):
    ...
    def construct(self):
        ...
        txt_title = [
            ...
            Tex(r"Partie I", font_size=48, color=BLACK),
        ]
        ...
        definition = [
            Tex(r"Un nombre triangulaire centré $c_n$ est", font_size=24, color=BLACK),
        ...
        results = [
            ...
            Tex(r"avec $t_n = 1 + \dots + n$", font_size=36, color=BLACK),
        ]
        ...
        txt_t1 = Tex(r"$t_n$", font_size=36, color=BLACK).\
        ...
        txt_t2 = Tex(r"$t_n$", font_size=36, color=BLACK).\
        ...
        txt_1 = Tex(r"$1$", font_size=36, color=BLACK).move_to(c0.get_center())
        self.play(
            c0.animate.set_color(ORANGE),
            Write(txt_1),
            Create(triangle_1),
            Write(txt_t1),
            Create(triangle_2),
